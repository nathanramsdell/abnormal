...
const NavigationBar = () => {
    ...
    return (
        <div className={`w-full ${scroll ? 'bg-assembly-white' : 'bg-assembly-purple text-assembly-white'} sticky top-0`}>
        <div className={`site__header flex justify-between transition-colors items-center font-light lg:px-5 max-w-screen-xl mx-auto h-20 `}>
